## Uber Clone
This is a web app that resembles the popular uber app. Built with Python Django Framework.
...
To run the tests use the command ``python3.6 manage.py test uber``
...
* **Newton Bii** - *Initial work* - [UberClone](https://github.com/NewtonBii/uber_clone)
